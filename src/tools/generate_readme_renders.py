...
def render_scene(glb_path: str, out_img: str, cam_pos, cam_target, light_dir=(0.75, 0.35, 0.6), hide_coll=True):
    ...
    key_obj.rotation_euler = mathutils.Vector(light_dir)
    ...
    fill_obj.rotation_euler = mathutils.Vector((-light_dir[0], -light_dir[1], -light_dir[2]))

    bpy.ops.render.render(write_still=True)
    print(f"Rendered: {out_img}")

# 1. Redmont Tavern (S_0100)
render_scene(
    "output/stages/S_01/S_0100/S_0100_composite.glb",
    "docs/images/s_0100_tavern.png",
    cam_pos=(16.0, -25.0, 18.0),
    cam_target=(0.0, 0.0, 3.5),
    light_dir=(0.8, 0.3, 0.6)
)

# 2. Village Scene (S_0000)
render_scene(
    "output/stages/S_00/S_0000/S_0000_composite.glb",
    "docs/images/s_0000_village.png",
    cam_pos=(25.0, -55.0, 38.0),
    cam_target=(-4.0, 6.0, 7.0),
    light_dir=(0.7, 0.2, 0.5)
)

# 3. Castle Gate & Outskirts (S_2000)
render_scene(
    "output/stages/S_20/S_2000/S_2000_composite.glb",
    "docs/images/s_2000_castle_gate.png",
    cam_pos=(55.0, -85.0, 55.0),
    cam_target=(-28.0, -20.0, 13.0),
    light_dir=(0.85, 0.3, 0.55)
)

# 4. Tigray Quarry Flat Backdrop Perspective Trick (S_1000)
# Angled side view showing the 2D mountain backdrop plane standing behind the 3D canyon path
render_scene(
    "output/stages/S_10/S_1000/S_1000_composite.glb",
    "docs/images/s_1000_flat_backdrop.png",
    cam_pos=(95.0, -75.0, 45.0),
    cam_target=(35.0, -20.0, 15.0),
    light_dir=(0.75, 0.35, 0.6)
)

# 5. S_0100 Collision Layers (Showing emerald walkable and cyan camera volumes)
render_scene(
    "output/S_0100_with_collision.glb",
    "docs/images/s_0100_collision_layers.png",
    cam_pos=(18.0, -28.0, 20.0),
